...
from .views import user_profile, login_required, set_bio, set_username, pullhh, pub_user_profile, follow_user, pullall, pullpfs, set_toppl, rem_toppl, pullfract
...
urlpatterns = [
    ...
    path('pullfract/', pullfract, name='pullfract'),
]
